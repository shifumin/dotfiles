...
- 抽出例: `https://github.com/kufu/hanica/pull/12345`
  - オーナー/リポジトリ: `kufu/hanica`
  - PR番号: `12345`
...
**リポジトリパス**:
- 絶対パス: `/Users/shifumi.fukunaga/ghq/github.com/kufu/smarthr-design-system`
...
2. **ガイドラインファイルの検索**
   - Grepツールを使用:
     ...
     - path: `/Users/shifumi.fukunaga/ghq/github.com/kufu/smarthr-design-system/src/content/`
...
- ❌ `~`を使ったパス表記（必ず絶対パス `/Users/shifumi.fukunaga/...` を使用）
...
```bash
/review-pr https://github.com/kufu/hanica/pull/12345
```
