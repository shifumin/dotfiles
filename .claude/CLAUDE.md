...
### 2025-06-21
- README.mdを英語で記述するガイドラインを追加

### 2025-06-17
- pdf-chapter-splitterプロジェクトから追加の汎用的な内容を統合
- publicインターフェースの明確化ガイドラインを追加
- エラーハンドリングのベストプラクティスを追加
- ファイル命名規則のガイドラインを追加
- パフォーマンス考慮事項のセクションを追加
- テストカバレッジの具体的な要件を追加

### 2025-06-16
- 要件や仕様に疑問があれば必ず立ち止まって質問する原則を追加
